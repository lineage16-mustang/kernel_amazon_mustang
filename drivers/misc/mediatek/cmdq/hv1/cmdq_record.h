 ...
 *		  please call cmdqRecSetSecure to set
 * command as SECURE after cmdqRecReset
 */
 ...
 *  AFTER cmdqRecFlush() returns,
 * or INSIDE the callback of cmdqRecFlushAsyncCallback().
 *
 */
 ...
 */
	...
	int32_t cmdqRecWaitThreadIdleWithTimeout(int threadID,
